...
#define vh_VIC_UART1
#define vh_VIC_UART1_bit

//Timer setting
#define vh_VIC_TIMER4 
#define vh_VIC_TIMER4_bit 

/*******************************************************************
   	GPIO
 *******************************************************************/
#define vh_GPA0CON			(*(volatile unsigned *)0x00000000)
#define vh_GPA0PUD			(*(volatile unsigned *)0x00000000)
//
...
#define vh_vSERIAL_CON			0x000000  	// Register Setting 2. GPA0_4=UART1 receives. GPA0_5=UART1 transmits
#define vh_vSERIAL_PUD			0x000000	//0xf00// Pull-up enable

#define vh_UART_CTL_BASE 		0xec000000	// UART 1 register base address

#define vh_ULCON	 		(*(volatile unsigned *)(vh_UART_CTL_BASE+0x0000))	// Specifies line control 400
#define vh_UCON	 			(*(volatile unsigned *)(vh_UART_CTL_BASE+0x0000))	// Specifies control 404
#define vh_UFCON	 		(*(volatile unsigned *)(vh_UART_CTL_BASE+0x0000))	// Specifies FIFO control 408
